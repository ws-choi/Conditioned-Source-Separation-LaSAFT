...
from lasaft.source_separation.conditioned.LaSAFT import TFC_LaSAFT, TFC_LightSAFT
...
class DCUN_TFC_GPoCM_LightSAFT(DenseCUNet_GPoCM):
...
class DCUN_TFC_GPoCM_LightSAFT_Framework(DenseCUNet_GPoCM_Framework):
    ...
    def __init__(self, n_fft, hop_length, num_frame,
        ...
        spec2spec = DCUN_TFC_GPoCM_LightSAFT(**tfc_tdf_net_kwargs)
        ...
        valid_kwargs = inspect.signature(DCUN_TFC_GPoCM_LightSAFT_Framework.__init__).parameters
